...
const PrivacyPolicyPage = () => {
  return (<>
    <GatsbySeo
      ...
      description={`Настоящий документ представляет собой правила использования данных интернет-пользователей, собираемых с использованием данного сайта`}
    ...
    <div className={`bg-black text-white px-5 w-full pt-16 lg:pt-28 pb-5`}>
      <div className={`prose lg:prose-xl prose-invert max-w-5xl md:mx-auto`}>
        ...
        <p>Настоящий документ &laquo;Политика конфиденциальности&raquo; (далее по тексту &ndash; &laquo;Политика&raquo;) представляет собой правила использования Касторским Ильей Вячеславовичем (далее &ndash; &laquo;мы&raquo; и/или &laquo;Администрация&raquo;) данных интернет-пользователей (далее &laquo;вы&raquo; и/или &laquo;Пользователь&raquo;), собираемых с использованием сайта https://3djew.mustbefamily.com (далее &ndash; &laquo;Сайт&raquo;).</p>
        <h2>1. Обрабатываемые данные</h2>
        <p>1.1. Мы не осуществляем сбор ваших персональных данных с использованием Сайта.</p>
        <p>1.2. Все данные, собираемые на Сайте, предоставляются и принимаются в обезличенной форме (далее &ndash; &laquo;Обезличенные данные&raquo;).</p>
